...
import sys,os,time    # Ошибка PEP8: импорты не упорядочены и через запятую
import math        # Ошибка PEP8: пустые строки между импортами не добавлены
...
if False: pass   # Ошибка PEP20: Да, это должно быть "Простой способ лучше, чем сложный", а это — «False»
